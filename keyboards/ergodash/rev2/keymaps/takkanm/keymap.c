...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_DOWN,                        KC_UP , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LOWER ,                        RAISE , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
		KC_GRV, KC_QUOT, ADJUST, KC_LALT,             KC_ESC,   KC_SPC ,KC_LGUI,        KC_RGUI, KC_ENT , KC_SPC,            KC_LCTL, KC_LBRC, KC_RBRC,   ADJUST  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                       KC_BSPC, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_DEL,                        KC_BSPC, KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, _______, \
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______  \
  ),
