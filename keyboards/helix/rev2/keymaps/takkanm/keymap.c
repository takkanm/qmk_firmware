...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_GRV,  ADJUST,  KC_LALT, XXXXXXX, KC_GUIEI, LOWER, KC_SPC,  KC_ENT, RAISE, KC_ALTKN,  KC_SPC,  KC_LBRC, KC_RBRC, KC_BSPC \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS,  KC_LBRC, KC_RBRC, KC_BSLS,  KC_TILD, \
