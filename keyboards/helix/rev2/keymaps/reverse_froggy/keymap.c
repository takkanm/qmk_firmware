...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_BASE] = LAYOUT( \
      LCTL(KC_Z),    KC_SCLN,       KC_LBRC,       KC_LPRN,   KC_LT,     KC_LCBR,                                KC_LCBR,  KC_LT,  KC_LPRN,  KC_LBRC,  KC_SCLN,  LCTL(KC_Z, \
      KANA,          KC_P,          KC_K,          KC_R,      KC_A,      KC_F,                                   KC_F,  KC_A,  KC_R,  KC_K,  KC_P,  KANA, \
      KC_BSPC,       KC_D,          KC_T,          KC_H,      KC_E,      KC_O,                                   KC_O,  KC_E,  KC_H,  KC_T,  KC_D,  KC_BSPC, \
      OSM(MOD_LSFT), KC_Y,          KC_S,          KC_N,      KC_I,      KC_U,       KC_SPC, KC_SPC,  KC_U,  KC_I,  KC_N,  KC_S,  KC_Y,  OSM(MOD_LSFT), \
      OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), MO(_SYM),  MO(_NUM),  OPT_TAP_SP, KC_ENT, KC_ENT,  OPT_TAP_SP,  MO(_NUM),  MO(_SYM),  OSM(MOD_LGUI),  OSM(MOD_LALT),  OSM(MOD_LCTL) \
      ),
   ...
   */
  [_OPT] = LAYOUT( \
      KC_ESC,  KC_COLN,KC_RBRC, KC_RPRN,KC_GT,     KC_RCBR,                   KC_RCBR,  KC_GT,  KC_RPRN,  KC_RBRC,  KC_COLN,  KC_ESC, \
      EISU,    KC_J,   KC_M,    KC_B,   KC_QUOT,   KC_TAB,                    KC_TAB,  KC_QUOT,  KC_B,  KC_M,  KC_J,  EISU, \
      KC_DOT,  KC_V,   KC_C,    KC_L,   KC_Z,      KC_Q,                      KC_Q,  KC_Z,  KC_L,  KC_C,  KC_V,  KC_DOT, \
      _______, KC_X,   KC_G,    KC_W,   KC_MINUS,  KC_DEL,  KC_ESC,  KC_ESC, KC_DEL,  KC_MINUS,  KC_W,  KC_G,  KC_X,  _______, \
      _______, _______,_______, KC_COMM,DESKTOP,   _______, _______, _______, _______,  DESKTOP,  KC_COMM,  _______,  _______,  _______ \
      ),
   ...
   */
  [_FUNC] = LAYOUT( \
      RGBRST,RGB_HUI, _______, RESET,   MAC,     WIN,                         WIN,  MAC,  RESET,  _______,  RGB_HUI,  RGBRST, \
      RGB1,  RGB_VAI, KC_F7,   KC_F8,   KC_F9,   _______,                     _______,  KC_F9,  KC_F8,  KC_F7,  RGB_VAI,  RGB1, \
      RGB2,  RGB_VAD, KC_F4,   KC_F5,   KC_F6,   KC_F12,                      KC_F12,  KC_F6,  KC_F5,  KC_F4,  RGB_VAD,  RGB2, \
      RGB3,  KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_F11,   _______,  _______, KC_F11,  KC_F3,  KC_F2,  KC_F1,  KC_F10,  RGB3, \
      RGBOFF,_______, _______, _______, _______, _______,  _______,  _______, _______,  _______,  _______,  _______,  _______,  RGBOFF \
      ),
   ...
   */
  [_SYM] = LAYOUT( \
      KC_INS,  KC_GRV,  _______, KC_PGUP, KC_PGDN, KC_CIRC,                   KC_CIRC,  KC_PGDN,  KC_PGUP,  _______,  KC_GRV,  KC_INS, \
      _______, KC_BSLS, KC_HASH, KC_EQL,  KC_QUES, KC_PERC,                   KC_PERC,  KC_QUES,  KC_EQL,  KC_HASH,  KC_BSLS,  _______, \
      _______, KC_DLR,  KC_UP,   KC_AT,   KC_EXLM, KC_PIPE,                   KC_PIPE,  KC_EXLM,  KC_AT,  KC_UP,  KC_DLR,  _______, \
      KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_UNDS, KC_AMPR, _______, _______, KC_AMPR,  KC_UNDS,  KC_RIGHT,  KC_DOWN,  KC_LEFT,  KC_CAPS, \
      _______, _______, KC_PSCR, _______, KC_TILD, _______, _______, _______, _______,  KC_TILD,  _______,  KC_PSCR,  _______,  _______ \
      ),
   ...
   */
  [_NUM] = LAYOUT( \
      _______,  _______, OSL(_FUNC), KC_HOME, KC_END,  _______,                          _______,  KC_END,  KC_HOME,  OSL(_FUNC),  _______,  _______, \
      _______,  KC_ASTR, KC_P7,      KC_P8,   KC_P9,   KC_MINS,                          KC_MINS,  KC_P9,  KC_P8,  KC_P7,  KC_ASTR,  _______, \
      KC_PDOT,  KC_SLSH, KC_P4,      KC_P5,   KC_P6,   KC_PLUS,                          _______,  KC_P6,  KC_P5,  KC_P4,  KC_SLSH,  KC_PDOT, \
      KC_NLCK,  KC_P0,   KC_P1,      KC_P2,   KC_P3,   LCTL(S(KC_F1)), _______, _______, LCTL(S(KC_F1)),  KC_P3,  KC_P2,  KC_P1,  KC_P0,  KC_NLCK, \
      _______,  _______, KC_PDOT,    KC_COMM, _______, _______,        _______, _______, _______,  _______,  KC_COMM,  KC_PDOT,  _______,  _______ \
      )
};
#else
