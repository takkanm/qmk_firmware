...
[_QWERTY] = LAYOUT( \
      ...
      KC_GRV,  ADJUST, KC_LALT, KC_ESC,  KC_SPC, KC_LGUI, LOWER, RAISE, KC_RGUI, KC_ENT,  KC_SPC,  KC_LBRC, KC_RBRC, KC_BSPC \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_F6,   _______, KC_HOME, KC_END,  _______, \
