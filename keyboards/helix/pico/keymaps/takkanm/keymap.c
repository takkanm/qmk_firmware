...
[_QWERTY] = LAYOUT( \
      ...
      KC_GRV,    ADJUST, KC_LALT, XXXXXXX, KC_GUIEI, LOWER, KC_SPC,     KC_ENT,   RAISE, KC_ALTKN, KC_LEFT, KC_UP,  KC_DOWN, KC_RGHT \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_UNDS, KC_PLUS,  KC_LBRC, KC_RBRC, KC_BSLS,  KC_TILD, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______ \
      ),
   ...
   */
  [_ADJUST] =  LAYOUT( \
      _______, RESET,   _______, _______, _______, _______,                   AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______, \
      _______, AU_ON,   AU_OFF,  MU_TOG,  MU_MOD,  AG_NORM,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
