...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [BASE] = LAYOUT( \
    KC_ESC,   KC_TAB,          KC_Q,        KC_W,    KC_E,   KC_R,     KC_T,       KC_Y,   KC_U,   KC_I,    KC_O,          KC_P,              KC_BSLS,        KC_BSPC, \
    KC_DELT,  CTL_T(KC_BSPC),  KC_A,        KC_S,    KC_D,   KC_F,     KC_G,       KC_H,   KC_J,   KC_K,    KC_L,          LT(SYMB, KC_SCLN), GUI_T(KC_QUOT), KC_ENT, \
    MO(SYMB), KC_LSFT,         CTL_T(KC_Z), KC_X,    KC_C,   KC_V,     KC_B,       KC_N,   KC_M,   KC_COMM, KC_DOT,        CTL_T(KC_SLSH),    KC_RSFT,        MO(META), \
    MO(META), LT(SYMB,KC_GRV), KC_QUOT,     KC_LALT, KC_BSPC, KC_SPC, KC_LGUI,     KC_RGUI, KC_SPC, KC_ENT,  CTL_T(KC_ESC), KC_LBRC,          KC_RBRC,        KC_FN1 \
  ),
