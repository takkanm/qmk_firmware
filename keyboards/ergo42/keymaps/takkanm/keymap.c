...
#define SYMB 2
#define GAME 3
#define RAISE MO(SYMB)
#define LOWER MO(META)
#define ADJUST MO(GAME)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
      ...
      KC_CTLESC, KC_A,   KC_S,    KC_D,    KC_F,     KC_G,  S(KC_9),    S(KC_0),  KC_H,  KC_J,     KC_K,    KC_L,   KC_SCLN, KC_QUOT, \
  ...
  [SYMB] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV, \
