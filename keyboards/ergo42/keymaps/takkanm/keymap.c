...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    MO(SYMB), KC_LSFT,         CTL_T(KC_Z), KC_X,    KC_C,   KC_V,     KC_B,       KC_N,   KC_M,   KC_COMM, KC_DOT,        CTL_T(KC_SLSH),    KC_RSFT,        KC_RSFT, \
    MO(META), LT(SYMB,KC_GRV), KC_QUOT,     KC_LALT, KC_BSPC, KC_LGUI, KC_SPC,     KC_SPC, KC_RGUI, KC_ENT,  CTL_T(KC_ESC), KC_LBRC,          KC_RBRC,        KC_FN1 \
  ),
